...
palindrome: 4668731596684224866951378664 (53 iterations, 28-digits). Surprisingly, there are palindromic numbers that
...
print(len(list(filter(lychrel, range(1, 10000)))))